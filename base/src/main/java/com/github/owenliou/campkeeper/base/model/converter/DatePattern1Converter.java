...
public class DatePattern1Converter implements AttributeConverter<LocalDate, String> {
    ...
    public String convertToDatabaseColumn(LocalDate attribute) {
        return (attribute == null)? null: DEFAULT_SETTINGS.DATE_FORMATTER_1.format(attribute);
    }

    @Override
    public LocalDate convertToEntityAttribute(String dbData) {
        return StringUtils.isBlank(dbData) ? null : LocalDate.parse(dbData, DEFAULT_SETTINGS.DATE_FORMATTER_1);
    }
